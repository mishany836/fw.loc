...
class Pagination
{
    ...
    public $perpage;//по сколько записей нужно выводить на странницу
    public $total;//общее колличество записей
    public $countPages;//общее кол-во страниц
    public $uri;// базовый адресс
    ...
    $startpage.$back.$page2left.$page1left . '<li class="page-link active"><a>' .$this->currentPage . '</a></li>' . $page1right . $page2right . $forward . $endpage . '</ul>';
    }
